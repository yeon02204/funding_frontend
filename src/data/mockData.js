...
export const CATEGORIES = [
  ...
  { id: "게임",          icon: "🎮",  label: "게임" },
  { id: "보드게임",       icon: "🎲",  label: "보드게임·TRPG" },
  { id: "디지털게임",     icon: "🕹️",  label: "디지털 게임" },
  { id: "웹툰",          icon: "📖",  label: "웹툰·만화" },
  { id: "웹툰리소스",     icon: "✏️",  label: "웹툰 리소스" },
  { id: "디자인문구",     icon: "📝",  label: "디자인 문구" },
  { id: "캐릭터굿즈",     icon: "🧸",  label: "캐릭터·굿즈" },
  { id: "홈리빙",        icon: "🏠",  label: "홈·리빙" },
  { id: "테크가전",       icon: "💻",  label: "테크·가전" },
  { id: "개발",          icon: "🖥️",  label: "개발·프로그래밍" },
  { id: "푸드",          icon: "🍽️",  label: "푸드" },
  { id: "향수뷰티",       icon: "🌸",  label: "향수·뷰티" },
  { id: "의류",          icon: "👗",  label: "의류" },
  { id: "잡화",          icon: "👜",  label: "잡화" },
  ...
  { id: "아트",          icon: "🖼️",  label: "예술" },
  { id: "사진",          icon: "📷",  label: "사진" },
  { id: "음악",          icon: "🎵",  label: "음악" },
  { id: "공연",          icon: "🎭",  label: "공연" },
  { id: "영화",          icon: "🎬",  label: "영화·비디오" },
];
...
export const SHORTCUT_TABS = [
  ...
  { icon: "🎮", label: "게임",         path: "/category/게임" },
  { icon: "🖥️", label: "개발",         path: "/category/개발" },
  { icon: "📖", label: "웹툰",         path: "/category/웹툰" },
  { icon: "🎵", label: "음악",         path: "/category/음악" },
  { icon: "🎨", label: "아트",         path: "/category/아트" },
